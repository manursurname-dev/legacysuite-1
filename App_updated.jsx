...
function App() {
  ...
  // إذا تم إرسال النموذج بنجاح - رسالة محسنة
  if (isSubmitted) {
    return (
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-6">
              <img 
                ...
                className="h-24 w-auto drop-shadow-2xl cursor-pointer hover:scale-105 transition-transform duration-300"
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        className="bg-white/20 border-white/30 text-white placeholder-white/60 backdrop-blur-sm focus:bg-white/30 transition-all duration-300"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.currentRank} onValueChange={(value) => handleInputChange('currentRank', value)}>
                      <SelectTrigger className="bg-white/20 border-white/30 text-white backdrop-blur-sm focus:bg-white/30 transition-all duration-300">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-white/20 border-white/30 text-white file:bg-white/20 file:border-0 file:text-white backdrop-blur-sm file:rounded-md file:px-3 file:py-1 hover:file:bg-white/30 transition-all duration-300"
                    />
                    {formData.rankImage && (
                      <p className="text-green-300 text-sm">✓ تم اختيار الملف: {formData.rankImage.name}</p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.stayNights} onValueChange={(value) => handleInputChange('stayNights', value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="ثلاث ليالي">ثلاث ليالي</SelectItem>
                        <SelectItem value="أربع ليالي">أربع ليالي</SelectItem>
                        <SelectItem value="خمس ليالي">خمس ليالي</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="paymentImage" className="text-white font-semibold flex items-center gap-2">
                      <Upload className="h-4 w-4" />
                      صورة تأكيد الدفع *
                    </Label>
                    <Input
                    ...
                    {formData.paymentConfirmationImage && (
                      <p className="text-green-300 text-sm">✓ تم اختيار الملف: {formData.paymentConfirmationImage.name}</p>
                    )}
                  </div>
                </div>
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold py-4 text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                >
                  {isSubmitting ? (
